...
public class CreateDbTables {
    ...
    public static void createTables(String DbName, String password) {
        try {
            ...
            String sql8 = "CREATE TABLE IF NOT EXISTS  hasEdited (EditorISBN VARCHAR(255), BookTitle VARCHAR(255), BookFirstYearEdition INT, EditionYear INT, FOREIGN KEY (EditorISBN) REFERENCES Editor (ISBN), FOREIGN KEY (BookTitle, BookFirstYearEdition) REFERENCES Book (Title, FirstYearEdition));";
            stmt8.executeUpdate(sql8);
            stmt8.close();
            System.out.println("Table HasEdited created successfully!");
             */
            //////////////////////////////////////////////////
            con.close();
