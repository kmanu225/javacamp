        ...
        try {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/" + DbName, "root",
                ...
                try (Statement stmt7 = con.createStatement()) {
                    String sql7 = "CREATE TABLE IF NOT EXISTS  HasBorrowed (BookCopyId INT, BorrowerLogin VARCHAR(30), BorrowingDate Date, LimitDate Date, GiveBackDate Date, FOREIGN KEY (BookCopyId) REFERENCES BookCopy (CopyId), FOREIGN KEY (BorrowerLogin) REFERENCES User (Login))"; // PRIMARY
                                                                                                                                                                                                                                                                                            // KEY
                                                                                                                                                                                                                                                                                            // (BookCopyId,
                                                                                                                                                                                                                                                                                            // BorrowerLogin)
